...
const PaymentModal: React.FC<PaymentModalProps> = ({
  ...
  const [paymentTimeout, setPaymentTimeout] = useState<ReturnType<
    typeof setTimeout
  > | null>(null);
  const [paymentDetails, setPaymentDetails] = useState<PaystackResponse | null>(
    null,
  );
  ...
  return (
    ...
    <div className="fixed inset-0 bg-black/80 backdrop-blur-sm flex items-end sm:items-center justify-center z-[9999] p-0 sm:p-4 animate-in fade-in duration-200">
      {/* FIXED: 
          1. Added 'flex flex-col' for sticky header/scrollable body 
          2. Added 'h-full sm:h-auto' to fill screen on mobile
          3. Added 'max-h-[95vh]' to ensure it fits
      */}
      <div
        ref={modalRef}
        className={`bg-[#001524] w-full sm:rounded-2xl border-t sm:border border-[#445048] shadow-2xl overflow-hidden relative animate-in slide-in-from-bottom-4 duration-300 flex flex-col h-[90dvh] sm:h-auto sm:max-h-[90vh] ${
            ...
            <>
              ...
              {step === "method" && (
                <div className="animate-in slide-in-from-left-4 duration-300">
                  ...
                  <div className="bg-gradient-to-br from-[#0f2434] to-[#1a3247] p-4 md:p-6 rounded-xl mb-6 border border-[#445048]/50 shadow-inner">
                    ...
                    {/* FIXED: grid-cols-2 on mobile (instead of implicit) to avoid squishing */}
                    <div className="grid grid-cols-2 md:grid-cols-3 gap-4 mb-4">
                      ...
                      <div className="space-y-2">
                        ...
                        <p className="text-white font-semibold">
                          {vehicleDetails.current_mileage?.toLocaleString() ||
                            "0"}{" "}
                          km
                        </p>
                      </div>
                    ...
                    {/* Specifications Grid */}
                    <div className="mb-4">
                      <h4 className="text-sm font-bold text-[#C4AD9D] uppercase mb-3 tracking-wider">
                        Specifications
                      </h4>
                      {/* FIXED: grid-cols-2 on mobile */}
                    ...
                    {vehicleFeatures.length > 0 && (
                      <div>
                        <h4 className="text-sm font-bold text-[#C4AD9D] uppercase mb-2 tracking-wider">
                          Features
                        </h4>
                        <div className="flex flex-wrap gap-2">
                          {vehicleFeatures.slice(0, 4).map(
                            (feature, index) =>
                              feature && (
                                <span
                                  key={index}
                  ...
                  <div className="bg-gradient-to-br from-[#0f2434] to-[#1a3247] p-4 rounded-xl mb-6 border border-[#445048]/50 shadow-inner">
                    <div className="flex justify-between items-end">
                      <div>
                        <p className="text-xs text-[#C4AD9D] uppercase font-bold tracking-wider">
                          Total Amount
                        </p>
                      ...
                      <div className="text-right">
                        <p className="text-xs text-[#C4AD9D]">
                          Booking Ref: #{bookingData.booking_id}
                        </p>
                        <p className="text-xs text-gray-500">
                          Vehicle ID: {vehicleDetails.vehicle_id}
                        </p>
                      </div>
                    </div>
                    ...
                    <div className="mt-3 pt-3 border-t border-[#445048]/50 text-xs space-y-1">
                      <div className="flex justify-between">
                        <span className="text-[#C4AD9D]">
                          Vehicle Daily Rate:
                        </span>
                        <span className="text-[#C4AD9D]">
                          KES {vehicleDetails.rental_rate || "0"}
                        </span>
                      </div>
                      <div className="flex justify-between">
                        <span className="text-[#C4AD9D]">
                        ...
                        <span className="text-[#C4AD9D]">
                          KES{" "}
                          {(bookingData.total_amount * 0.02).toLocaleString()}
                        </span>
                      </div>
                    </div>
                  </div>
                ...
                >
                  ...
                  <div className="space-y-4">
                    <div className="bg-[#445048]/20 p-4 rounded-lg border border-[#445048]">
                      <p className="text-sm text-[#C4AD9D]">
                        Enter your M-Pesa number. A payment request will be sent
                        to this number.
                      </p>
                    </div>

                    <div>
                      <label className="text-xs font-bold text-[#C4AD9D] uppercase mb-2 block">
                        M-Pesa Number
                      </label>
                ...
                <div className="animate-in slide-in-from-bottom-4 duration-300">
                  <div className="text-center py-12">
                    ...
                    <p className="text-[#C4AD9D] mb-6">
                      Please wait while we connect to the secure payment
                      system...
                    </p>
                    ...
                    <p className="text-xs text-gray-500 mt-6">
                      This may take a few seconds. If nothing appears in 15

...
const VehicleDetailsModal: React.FC<VehicleDetailsModalProps> = ({
  ...
  const [selectedTab, setSelectedTab] = useState<"details" | "booking">(
    "details",
  );
                  ...
                  <div className="bg-gradient-to-br from-[#0f2434] to-[#1a3247] rounded-xl p-6 border border-[#445048]">
                    ...
                    <div className="space-y-3">
                      <div className="flex justify-between items-center">
                        ...
                        <span className="text-2xl font-bold text-[#027480]">
                          ${vehicle.rental_rate || "0"}
                        </span>
                      </div>
                      {vehicle.on_promo && (
                        <div className="flex items-center gap-2 p-3 bg-[#F57251]/10 rounded-lg border border-[#F57251]/20">
                          ...
                          <span className="text-sm text-[#F57251] font-medium">
                ...
                <div>
                  ...
                  <div className="bg-gradient-to-br from-[#0f2434] to-[#1a3247] rounded-xl p-6 border border-[#445048] space-y-4">
                    ...
                    <SpecRow
                      ...
                      value={`${vehicle.seating_capacity || "0"} Seats`}
                      icon={<Users size={16} />}
                    />
                    <SpecRow
                      label="Vehicle Type"
                      value={vehicle.vehicle_type || "Sedan"}
                      icon={<Car size={16} />}
                    />
                ...
                <div>
                  ...
                  <div className="bg-gradient-to-br from-[#0f2434] to-[#1a3247] rounded-xl p-6 border border-[#445048]">
                    {features.length > 0 ? (
                        ...
                        {features.map(
                          (feat: string, i: number) =>
                            feat && (
                              <div
                                key={i}
                                className="flex items-center gap-2 p-3 bg-[#001524] rounded-lg border border-[#445048]"
                              >
                                <CheckCircle
                                  size={14}
                      ...
                      <p className="text-[#C4AD9D] text-center py-4">
                ...
                <div className="bg-gradient-to-br from-[#0f2434] to-[#1a3247] rounded-xl p-6 border border-[#445048]">
                  ...
                  <div className="flex items-center gap-4 mb-6 p-4 bg-[#001524] rounded-lg border border-[#445048]">
                    ...
                    <div>
                      ...
                      <p className="text-[#027480] font-bold text-lg">
                        ${vehicle.rental_rate || "0"}{" "}
                        <span className="text-xs text-[#C4AD9D] font-normal">
                          / day
                        </span>
                      </p>
                    </div>
                    ...
                    <div className="space-y-3 border-t border-[#445048] pt-4">
                      <div className="flex justify-between text-sm">
                        <span className="text-[#C4AD9D]">
                          Vehicle Rental ({days} days)
                        </span>
                        <span className="text-white font-medium">
                          ${Number(vehicle.rental_rate || 0) * days}
                        </span>
                      </div>
                      ...
                      <div className="border-t border-[#445048] pt-3 mt-2">
                        <div className="flex justify-between items-center">
                          ...
                          <span className="text-2xl font-bold text-[#F57251]">
                    ...
                    <div className="mt-4 p-3 bg-red-900/20 rounded-lg border border-red-900/30">
                      <div className="flex items-center gap-2">
                        ...
                        <p className="text-red-400 text-sm">
                          ...
                          {vehicle.status.toLowerCase()}. Please check back
                          later.
                        </p>
                      </div>
                    </div>
                  ...
                  <div className="space-y-3 text-sm">
                    <div className="flex items-start gap-3">
                      ...
                      <p className="text-[#C4AD9D]">
                        Full insurance coverage included with every booking
                      </p>
                    </div>
                    <div className="flex items-start gap-3">
                      <Clock
              ...
              <div>
                ...
                <form onSubmit={handleBookingSubmit} className="space-y-6">
                  ...
                  {days > 0 && (
                    <div className="p-4 bg-[#027480]/10 rounded-lg border border-[#027480]/20">
                      <div className="flex justify-between items-center">
                        ...
                        <span className="text-[#027480] font-bold">
                          {days} day{days !== 1 ? "s" : ""}
                        </span>
                      </div>
                    </div>
                  ...
                  <div className="flex items-start gap-3 p-4 bg-[#0f2434] rounded-lg border border-[#445048]">
                    ...
                    <label
                      htmlFor="terms"
                      className="text-sm text-[#C4AD9D] cursor-pointer select-none"
                    >
                      I agree to the{" "}
                      <span className="text-[#027480] hover:underline">
                        Rental Terms & Conditions
                      </span>{" "}
                      and understand the cancellation policy. I confirm that I
                      have a valid driver's license and meet the age
                      requirements.
                    </label>
                  </div>
...
const InfoBox = ({ label, value, highlight, large, icon }: any) => (
  <div className="space-y-1">
    <div className="flex items-center gap-2">
      {icon}
      <span className="text-xs text-[#C4AD9D] uppercase tracking-wider">
        {label}
      </span>
    </div>
    <span
      className={`block ${large ? "text-2xl" : "text-lg"} font-bold ${highlight ? "text-[#027480]" : "text-white"}`}
    >
      {value || "-"}
    </span>
  </div>
...
const Checkbox = ({ label, description, checked, onChange }: any) => (
  <label className="flex items-start gap-3 cursor-pointer group">
    <div
      className={`w-6 h-6 rounded border-2 flex items-center justify-center transition-all mt-0.5 ${checked ? "bg-[#027480] border-[#027480]" : "border-[#445048] group-hover:border-[#027480]"}`}
    >
    ...
    <div className="flex-1">
      <span
        className={`block font-medium transition-colors ${checked ? "text-white" : "text-[#C4AD9D]"}`}
      >
        {label}
      </span>
      {description && (

...
const Navbar = () => {
    ...
    return (_jsx("div", { className: "sticky top-0 z-50 p-4 bg-[#E9E6DD] shadow-md", children: _jsxs("nav", { className: "max-w-7xl mx-auto bg-[#001524] rounded-2xl p-4 shadow-lg", children: [_jsxs("div", { className: "flex items-center justify-between", children: [_jsxs(Link, { to: "/", className: "flex items-center space-x-3", children: [_jsx("img", { src: "/logo.png", alt: "Logo", className: "w-10 h-10 rounded-full object-cover" }), _jsxs("div", { children: [_jsx("h1", { className: "text-xl md:text-2xl font-bold text-[#E9E6DD]", children: "VansKE Car Rental" }), _jsx("p", { className: "text-[#C4AD9D] text-sm", children: "Luxury & Performance" })] })] }), _jsx("div", { className: "hidden lg:flex items-center space-x-8", children: navLinks.map((link) => (_jsx(Link, { to: link.path, className: `text-lg font-medium transition-colors duration-200 ${isActive(link.path)
                                    ? "text-[#F57251]"

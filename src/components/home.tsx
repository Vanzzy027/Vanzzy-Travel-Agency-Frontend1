...
const Home: React.FC = () => {
  ...
  return (
    <main className="flex-1">
      ...
      {/* Stats Section */}
      <div className="bg-[#001524] rounded-2xl mx-6 my-8 p-8">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-6 text-center">
          <div>
            <div className="text-3xl font-bold text-[#F57251] mb-2">50+</div>
            <div className="text-[#E9E6DD]">Premium Vehicles</div>
          </div>
          <div>
            <div className="text-3xl font-bold text-[#027480] mb-2">24/7</div>
            <div className="text-[#E9E6DD]">Customer Support</div>
          </div>
          <div>
            <div className="text-3xl font-bold text-[#D6CC99] mb-2">1000+</div>
            <div className="text-[#E9E6DD]">Happy Customers</div>
          </div>
          <div>
            <div className="text-3xl font-bold text-[#C4AD9D] mb-2">5★</div>
            <div className="text-[#E9E6DD]">Average Rating</div>
          </div>
        </div>
      </div>
    </main>

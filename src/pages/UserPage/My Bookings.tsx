...
const UserBookingsPage = () => {
    ...
    return (
      <div className="min-h-[60vh] flex items-center justify-center bg-[#001524] p-4">
        <div className="flex flex-col items-center gap-4">
          ...
          <div className="text-[#027480] text-lg md:text-xl font-bold">
    ...
    return (
      <div className="min-h-[60vh] flex items-center justify-center bg-[#001524] p-4">
        <div className="text-center text-[#F57251] p-6 md:p-8 border border-[#F57251] rounded-xl md:rounded-2xl bg-[#F57251]/10 max-w-md w-full">
          ...
          <p className="text-sm md:text-base text-[#C4AD9D]">
  ...
  const getVehicleImage = (booking: BookingDetail) => {
    const images = booking.vehicle_images; // expecting array of URLs
    if (!images || images.length === 0)
      return "https://images.unsplash.com/photo-1549317661-bd32c8ce0db2?auto=format&fit=crop&w=600&q=80"; // optional local placeholder

    try {
      if (Array.isArray(images)) return images[0]; // take first image
      const parsed = JSON.parse(images); // if stored as JSON string
    ...
    <div className="min-h-screen bg-[#001524] p-4 md:p-6 lg:p-8 xl:p-10 text-[#E9E6DD] pb-16 md:pb-20">
      ...
      <header className="mb-6 md:mb-8 lg:mb-10">
        <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-4 md:gap-6">
          <div>
            <h1 className="text-2xl md:text-3xl lg:text-4xl font-bold text-[#E9E6DD]">
              My Bookings
            </h1>
            <p className="text-[#C4AD9D] text-sm md:text-base mt-1">
              Manage your trips, payments, and history
            </p>
          </div>
          <div className="flex gap-3 md:gap-4 w-full md:w-auto">
            ...
            <div className="bg-[#0f2434] px-4 py-2 md:px-5 md:py-3 rounded-lg md:rounded-xl border border-[#445048] flex-1 md:flex-none">
              ...
              <p className="text-lg md:text-xl lg:text-2xl font-bold text-[#027480]">
      ...
      {bookings && bookings.length === 0 && (
        <div className="text-center py-12 md:py-16 lg:py-20 bg-[#0f2434]/50 rounded-xl md:rounded-2xl lg:rounded-3xl border border-[#445048] border-dashed">
          <Car className="w-12 h-12 text-[#F57251]" />{" "}
          <h3 className="text-lg md:text-xl lg:text-2xl font-bold text-white mb-2">
            No trips yet?
          </h3>
          <p className="text-[#C4AD9D] text-sm md:text-base mb-6">
      ...
      {pendingBookings.length > 0 && (
        <section className="mb-8 md:mb-10 lg:mb-12">
          <div className="flex items-center gap-2 mb-4 md:mb-6">
            ...
            <h2 className="text-lg md:text-xl font-bold text-[#F57251]">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-2 xl:grid-cols-3 gap-4 md:gap-6">
            {pendingBookings.map((booking) => (
              <div
                ...
                className="bg-[#0f2434] border border-[#F57251] rounded-xl md:rounded-2xl overflow-hidden shadow-[0_0_15px_rgba(245,114,81,0.15)] flex flex-col"
              >
                <div className="bg-[#F57251]/10 p-3 md:p-4 border-b border-[#F57251]/30 flex justify-between items-center">
                  <span className="text-[#F57251] font-bold text-xs uppercase tracking-wider">
                    Awaiting Payment
                  </span>
                  <span className="text-xl md:text-2xl font-bold text-[#E9E6DD]">
      ...
      {activeBookings.length > 0 && (
        <section className="mb-8 md:mb-10 lg:mb-12">
          <div className="flex items-center gap-2 mb-4 md:mb-6">
            ...
            <h2 className="text-lg md:text-xl font-bold text-[#027480]">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4 md:gap-6">
            {activeBookings.map((booking) => (
              <div
                key={booking.booking_id}
                className="bg-[#001524] border border-[#445048] rounded-xl md:rounded-2xl p-4 md:p-5 lg:p-6 relative group hover:bg-[#022a35] transition-colors"
              >
                ...
                <div className="mb-3 md:mb-4">
                  ...
                  <p className="text-[#C4AD9D] text-xs uppercase tracking-wide">
                ...
                <div className="bg-[#000d16] p-3 md:p-4 rounded-lg md:rounded-xl border border-[#445048] space-y-2 md:space-y-3">
                  <div className="flex justify-between items-center text-xs md:text-sm">
                    ...
                    <span className="text-[#E9E6DD] font-medium">
                      {formatDate(booking.booking_date)}
                    </span>
                  </div>
                  <div className="flex justify-between items-center text-xs md:text-sm">
                  ...
                  <div className="border-t border-[#445048] pt-2 mt-2 flex justify-between items-center">
                    ...
                    <span className="font-bold text-[#027480] text-base md:text-lg">
                      ${booking.total_amount}
                    </span>
                  </div>
                </div>
      ...
      {historyBookings.length > 0 && (
        <section>
          <div className="flex items-center gap-2 mb-4 md:mb-6">
            ...
            <h2 className="text-lg md:text-xl font-bold text-[#445048]">
              History
            </h2>
          </div>
              ...
              <table className="w-full text-left border-collapse">
                ...
                <tbody className="text-sm">
                  {historyBookings.map((booking) => (
                    <tr
                      key={booking.booking_id}
                      className="border-b border-[#445048]/50 hover:bg-[#152e40] transition-colors last:border-0"
                    >
                      <td className="py-3 px-4 lg:px-6 text-[#445048] font-mono">
                        #{booking.booking_id}
                      </td>
                      ...
                      <td className="py-3 px-4 lg:px-6 font-bold text-[#E9E6DD]">
                        ${booking.total_amount}
                      </td>
                      <td className="py-3 px-4 lg:px-6">
                        <span
                          className={`px-2 py-1 rounded text-xs font-bold flex items-center justify-center gap-1 w-24 ${
            ...
            <div className="md:hidden">
              <div className="divide-y divide-[#445048]/50">
                {historyBookings.map((booking) => (
                  <div
                    key={booking.booking_id}
                    className="p-4 hover:bg-[#152e40] transition-colors"
                  >
                    <div className="flex justify-between items-start mb-2">
                      <div>
                        <p className="text-[#445048] font-mono text-xs">
                          #{booking.booking_id}
                        </p>
                    ...
                    <div className="flex justify-between items-center">
                      ...
                      <div className="font-bold text-[#E9E6DD]">
                        ${booking.total_amount}
                      </div>
                    </div>
                  </div>
        ...
        <PaymentModal
          ...
          bookingData={{
            ...
            vehicle_manufacturer:
              selectedBookingForPayment.vehicle_manufacturer,

  ...
  return (
    <div className="space-y-4 md:space-y-6 lg:space-y-8">
      ...
      {activeBooking ? (
        <div className="bg-gradient-to-r from-[#001524] to-[#027480] rounded-xl md:rounded-2xl lg:rounded-3xl p-4 md:p-6 lg:p-8 shadow-xl border border-[#445048] relative overflow-hidden">
          <div className="relative z-10">
            ...
            <div className="grid md:grid-cols-2 gap-6 items-center">
              <div>
                <h1 className="text-xl md:text-2xl lg:text-3xl font-bold text-[#E9E6DD] mb-2">
                  On the road?
                </h1>
                <p className="text-[#C4AD9D] text-sm md:text-base mb-4">
                  You are currently renting a vehicle.
                </p>
        ...
        <div className="bg-[#445048] rounded-xl md:rounded-2xl lg:rounded-3xl p-4 md:p-6 lg:p-8 shadow-xl text-center md:text-left relative overflow-hidden">
          <div className="relative z-10">
            <div className="grid md:grid-cols-2 gap-6 items-center">
              <div>
                <h1 className="text-2xl md:text-3xl lg:text-4xl font-bold text-[#E9E6DD] mb-2">
                  Ready for your next trip?
                </h1>
                <p className="text-[#C4AD9D] text-sm md:text-base mb-6">
                  Choose from our premium fleet of SUVs, Sedans, and
                  Off-roaders.
                </p>
                <Link
              ...
              <div className="hidden md:flex justify-center opacity-50">
                <Car
                  className="w-16 h-16 lg:w-24 lg:h-24 text-[#C4AD9D]"
                  strokeWidth={1.8}
                />
              </div>
            </div>
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 md:gap-6">
        <div className="bg-[#001524] p-4 md:p-6 rounded-xl md:rounded-2xl border-l-4 border-[#027480] shadow-lg">
          <div className="flex items-center justify-between mb-2">
            <p className="text-[#C4AD9D] text-xs md:text-sm font-medium">
              Upcoming Trips
            </p>
            <Calendar className="w-4 h-4 md:w-5 md:h-5 text-[#027480]" />
          </div>
          <p className="text-2xl md:text-3xl font-bold text-[#E9E6DD]">
            {upcomingBooking ? "1" : "0"}
          </p>
          {upcomingBooking && (
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6 md:gap-8">
        ...
        <div className="lg:col-span-2 bg-[#001524] rounded-xl md:rounded-2xl p-4 md:p-6 shadow-lg border border-[#445048]/30">
          <div className="flex justify-between items-center mb-4 md:mb-6">
            <h3 className="text-lg md:text-xl font-bold text-[#E9E6DD]">
              Recent Activity
            </h3>
            <Link
              to="/UserDashboard/my-bookings"
              className="text-[#027480] text-xs md:text-sm hover:underline font-medium"
            >
              View All
            </Link>
          </div>
          ...
          <div className="space-y-3 md:space-y-4">
            {bookings?.slice(0, 4).map((booking) => (
              <div
                ...
                className="flex items-center justify-between p-3 md:p-4 bg-[#445048]/20 rounded-lg md:rounded-xl hover:bg-[#445048]/40 transition-colors"
              >
                <div className="flex items-center space-x-3 md:space-x-4">
                  <div className="bg-[#445048] p-2 md:p-3 rounded-lg flex items-center justify-center">
                    <Car
                      className="w-5 h-5 md:w-6 md:h-6 text-[#E9E6DD]"
                      strokeWidth={2}
                    />
                  </div>
                  <div className="flex-1 min-w-0">
                    <p className="text-[#E9E6DD] font-semibold text-sm md:text-base truncate">
                ...
                <div className="text-right ml-2">
                  <p className="text-[#E9E6DD] font-bold text-sm md:text-base">
                    ${booking.total_amount}
                  </p>
                  <span
                    className={`text-xs px-2 py-0.5 rounded ${
                      booking.status === "Active"
                        ? "bg-[#027480]/20 text-[#027480]"
                        : booking.status === "Confirmed"
                          ? "bg-[#D6CC99]/20 text-[#D6CC99]"
            ...
            {!bookings?.length && (
              <div className="text-[#C4AD9D] text-center py-4 text-sm md:text-base">
                ...
                <Link
                  to="/UserDashboard/vehicles"
                  className="text-[#027480] hover:underline ml-2"
                >
        ...
        <div className="bg-[#001524] rounded-xl md:rounded-2xl p-4 md:p-6 shadow-lg border border-[#445048]/30">
          ...
          <div className="space-y-3 md:space-y-4">
            <div className="flex items-start space-x-3 p-3 bg-[#D6CC99]/10 rounded-lg border border-[#D6CC99]/20">
              <Bell className="w-4 h-4 text-[#D6CC99]" strokeWidth={2} />
              <div className="flex-1 min-w-0">
                <p className="text-[#E9E6DD] text-xs md:text-sm font-semibold">
                  Complete Profile
                </p>
                <p className="text-[#C4AD9D] text-xs mt-1">
                  Add your driver's license to speed up checkout.
                </p>
              </div>
            </div>

            <div className="flex items-start space-x-3 p-3 bg-[#027480]/10 rounded-lg border border-[#027480]/20">
              <Tag className="w-4 h-4 text-[#027480]" strokeWidth={2} />{" "}
              <div className="flex-1 min-w-0">
                <p className="text-[#E9E6DD] text-xs md:text-sm font-semibold">
                  New Promo Available
                </p>
                <p className="text-[#C4AD9D] text-xs mt-1">
                  Get 10% off your next weekend rental.
                </p>
              </div>
            </div>
            ...
            <div className="flex items-start space-x-3 p-3 bg-[#F57251]/10 rounded-lg border border-[#F57251]/20">
              ...
              <div className="flex-1 min-w-0">
                ...
                <p className="text-[#C4AD9D] text-xs mt-1">
                  Review our updated terms and conditions.
                </p>
              </div>
            </div>
      ...
      <div className="lg:hidden grid grid-cols-2 gap-3 md:gap-4">
        ...
        >
          <Car className="w-5 h-5 mx-auto mb-1" strokeWidth={2} />{" "}
        ...
        >
          <ClipboardList className="w-5 h-5 mx-auto mb-1" strokeWidth={2} />{" "}
        ...
        >
          <User className="w-5 h-5 mx-auto mb-1" strokeWidth={2} />{" "}
        ...
        >
          <LifeBuoy className="w-5 h-5 mx-auto mb-1" strokeWidth={2} />{" "}

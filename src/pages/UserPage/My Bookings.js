    ...
    const getVehicleImage = (booking) => {
        ...
        try {
            if (Array.isArray(images))
                return images[0]; // take first image

...
const UserPaymentsPage = () => {
    ...
    // 1. Simplify the "Download" button to just take them to the receipt
    const handleDownloadReceipt = (paymentId) => {
        toast.info("Opening receipt view...");

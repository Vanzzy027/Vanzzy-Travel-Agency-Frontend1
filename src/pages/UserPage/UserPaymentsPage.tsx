        ...
        <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-4 mb-6">
          ...
          <div className="flex items-center gap-4">
            <div className="text-right">
              ...
              <p className="text-2xl font-bold text-[#027480]">
        ...
        <div className="overflow-x-auto">
          <table className="w-full">
            <thead className="bg-[#001524]">
              <tr>
                <th className="py-4 px-6 text-left text-sm font-semibold text-[#C4AD9D]">
                  Transaction
                </th>
                <th className="py-4 px-6 text-left text-sm font-semibold text-[#C4AD9D]">
                  Vehicle
              ...
              {filteredPayments.map((payment) => {
                ...
                return (
                  ...
                  >
                    ...
                    <td className="py-4 px-6">
                      <div
                        className={`inline-flex items-center gap-2 px-3 py-1 rounded-full text-xs font-medium border ${statusInfo.bgColor} ${statusInfo.borderColor}`}
                      >
                        {statusInfo.icon}
                    ...
                    <td className="py-4 px-6">
                      <div className="flex gap-2">
                        ...
                        <button
                          onClick={() =>
                            handleDownloadReceipt(payment.payment_id)
                          }
        ...
        <div className="flex items-start gap-3">
          ...
          <div>
            ...
            <ul className="text-sm text-[#C4AD9D] space-y-1 list-disc list-inside">
              ...
              <li>
                Payments may take up to 24 hours to reflect as "Completed"
              </li>

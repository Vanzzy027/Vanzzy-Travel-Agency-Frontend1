...
import { Car, CalendarDays, DollarSign, CarFront, Users, BarChart3, } from "lucide-react";
const AdminDashboardHome = () => {
    ...
    return (_jsxs("div", { className: "space-y-6", children: [_jsxs("div", { className: "mb-8", children: [_jsx("h1", { className: "text-3xl font-bold text-[#001524] mb-2", children: "Admin Overview" }), _jsx("p", { className: "text-[#445048]", children: "Monitor business performance and fleet status." })] }), _jsx("div", { className: "grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-8", children: stats.map((stat, index) => {
                    ...
                    return (_jsx("div", { className: "bg-[#001524] rounded-2xl p-6 shadow-lg", children: _jsxs("div", { className: "flex items-center justify-between", children: [_jsxs("div", { children: [_jsx("p", { className: "text-[#C4AD9D] text-sm font-semibold mb-2", children: stat.title }), _jsx("div", { className: `text-2xl font-bold ${stat.color}`, children: stat.value })] }), _jsx(Icon, { size: 28, strokeWidth: 2.2, className: stat.color })] }) }, index));
                }) }), _jsx("div", { className: "grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-8", children: quickActions.map((action, index) => {
                    const Icon = action.icon;
                    return (_jsxs(Link, { to: action.path, className: `${action.color} text-[#E9E6DD] rounded-2xl p-6 shadow-lg hover:scale-105 transition-transform duration-300 group`, children: [_jsx("div", { className: "mb-3 group-hover:scale-110 transition-transform duration-300", children: _jsx(Icon, { size: 30, strokeWidth: 2.2, className: "text-inherit" }) }), _jsx("h3", { className: "font-bold text-lg mb-2", children: action.label }), _jsx("p", { className: "text-sm opacity-90", children: action.description })] }, index));
                                        ...
                                        return (_jsxs("div", { className: "flex items-center justify-between p-4 bg-[#445048] rounded-lg", children: [_jsxs("div", { children: [_jsx("div", { className: "text-[#E9E6DD] font-semibold", children: booking.user
                                                                ...
                                                                : `Booking #${booking.booking_id}` }), _jsxs("div", { className: "text-[#C4AD9D] text-sm", children: [booking.start_date
                                                                    ...
                                                                    : new Date(booking.booking_date).toLocaleDateString(), booking.end_date &&
                                                                    ` - ${new Date(booking.end_date).toLocaleDateString()}`] }), _jsxs("div", { className: "text-[#C4AD9D] text-xs", children: ["$", booking.total_amount] })] }), _jsx("span", { className: `px-3 py-1 rounded-full text-xs font-semibold ${booking.status === "Active"
                                                ...
                                                try {
                                                    ...
                                                    return "https://images.unsplash.com/photo-1549317661-bd32c8ce0db2?auto=format&fit=crop&w=150&q=80";
                                                        ...
                                                        ? "text-[#027480]"
                                                        : "text-[#F57251]"}`, children: vehicle.status })] })] }, vehicle.vehicle_id))) })] })] })] }));
};

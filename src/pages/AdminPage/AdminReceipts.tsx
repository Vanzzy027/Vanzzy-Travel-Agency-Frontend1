...
const AdminReceipts: React.FC = () => {
  ...
  const mpesaCount = receipts.filter(
    (r) => r.payment_method === "M-Pesa",
  ).length;
    ...
    <div className="space-y-6">
      <div className="flex justify-between items-center">
        ...
        <div className="text-sm text-gray-400">
          Total: {receipts.length} receipts • Revenue: KES{" "}
                ...
                <tr key={receipt.payment_id} className="hover:bg-[#0f2434]/50">
                  ...
                  <td className="py-3 px-4">
                    <div className="flex gap-2">
                      <button
                        onClick={() =>
                          navigate(`/receipt/${receipt.payment_id}`)
                        }

...
const FleetManagement = () => {
    ...
    const handleCreateSpecStep = async (e) => {
        ...
        try {
            ...
            const specPayload = {
                ...
                promo_start_date: formData.on_promo
    ...
    const handleCreateInventoryStep = async (e) => {
        ...
        const specId = useExistingSpec
            ? selectedExistingSpecId
            : createdSpecData?.id;
        if (!specId) {
    ...
    return (_jsxs("div", { className: "space-y-6 p-4 min-h-screen bg-[#001524]", children: [_jsxs("div", { className: "flex flex-col md:flex-row justify-between items-start md:items-center gap-4", children: [_jsxs("div", { children: [_jsx("h1", { className: "text-3xl font-bold text-white", children: "Fleet Management" }), _jsx("p", { className: "text-[#C4AD9D]", children: "Manage specifications and fleet inventory." })] }), _jsxs("div", { className: "flex gap-3 w-full md:w-auto", children: [_jsxs("div", { className: "relative flex-1 md:w-64", children: [_jsx(Search, { className: "absolute left-3 top-3 text-gray-400", size: 18 }), _jsx("input", { type: "text", placeholder: "Search by model, plate, or VIN...", value: searchTerm, onChange: (e) => setSearchTerm(e.target.value), className: "pl-10 pr-4 py-2 w-full bg-[#0f2434] border border-[#445048] text-white rounded-lg focus:outline-none focus:ring-2 focus:ring-[#027480]" })] }), _jsxs("button", { onClick: () => {
                                    ...
                                    setIsModalOpen(true);
                                        ...
                                        return (_jsxs("tr", { className: "hover:bg-[#1a3247] transition-colors text-white", children: [_jsx("td", { className: "p-4", children: _jsxs("div", { className: "flex items-center gap-3", children: [_jsxs("div", { className: "w-16 h-16 rounded-lg overflow-hidden bg-gray-700 flex items-center justify-center", children: [images[0] ? (_jsx("img", { src: images[0], alt: `${v.manufacturer} ${v.model}`, className: "w-full h-full object-cover", onError: (e) => {
                                                            ...
                                                            }, className: "w-full bg-[#0f2434] border border-[#445048] rounded-lg p-3 text-white focus:outline-none focus:ring-2 focus:ring-[#027480]", children: [_jsx("option", { value: "", children: "-- Select a specification --" }), allSpecs?.map((spec) => (_jsxs("option", { value: spec.vehicleSpec_id, children: [spec.manufacturer, " ", spec.model, " (", spec.year, ") -", " ", spec.vehicle_type] }, spec.vehicleSpec_id)))] }), _jsx("p", { className: "text-xs text-[#C4AD9D] mt-2", children: "Selecting an existing spec will pre-fill the form below" })] }))] })), _jsxs("div", { className: "grid grid-cols-1 md:grid-cols-2 gap-4", children: [_jsxs("div", { className: "space-y-1", children: [_jsx("label", { className: "text-xs font-bold text-[#C4AD9D] uppercase", children: "Manufacturer *" }), _jsx("input", { required: true, className: "w-full bg-[#001524] border border-[#445048] text-white p-3 rounded-lg", value: formData.manufacturer, onChange: (e) => setFormData({
                                                                ...formData,
                                                                manufacturer: e.target.value,
                                                            }), placeholder: "e.g. Toyota" })] }), _jsxs("div", { className: "space-y-1", children: [_jsx("label", { className: "text-xs font-bold text-[#C4AD9D] uppercase", children: "Model *" }), _jsx("input", { required: true, className: "w-full bg-[#001524] border border-[#445048] text-white p-3 rounded-lg", value: formData.model, onChange: (e) => setFormData({ ...formData, model: e.target.value }), placeholder: "e.g. Camry" })] }), _jsxs("div", { className: "space-y-1", children: [_jsx("label", { className: "text-xs font-bold text-[#C4AD9D] uppercase", children: "Type" }), _jsxs("select", { className: "w-full bg-[#001524] border border-[#445048] text-white p-3 rounded-lg", value: formData.vehicle_type, onChange: (e) => setFormData({
                                                                ...formData,
                                                                vehicle_type: e.target.value,
                                                            }), children: [_jsx("option", { value: "Sedan", children: "Sedan" }), _jsx("option", { value: "SUV", children: "SUV" }), _jsx("option", { value: "Truck", children: "Truck" }), _jsx("option", { value: "Van", children: "Van" }), _jsx("option", { value: "Hatchback", children: "Hatchback" }), _jsx("option", { value: "Coupe", children: "Coupe" })] })] }), _jsxs("div", { className: "space-y-1", children: [_jsx("label", { className: "text-xs font-bold text-[#C4AD9D] uppercase", children: "Year" }), _jsx("input", { type: "number", required: true, min: "1900", max: new Date().getFullYear() + 1, className: "w-full bg-[#001524] border border-[#445048] text-white p-3 rounded-lg", value: formData.year, onChange: (e) => setFormData({
                                                                ...formData,
                                                                year: parseInt(e.target.value),
                                                            }) })] }), _jsxs("div", { className: "space-y-1", children: [_jsx("label", { className: "text-xs font-bold text-[#C4AD9D] uppercase", children: "Fuel Type" }), _jsxs("select", { className: "w-full bg-[#001524] border border-[#445048] text-white p-3 rounded-lg", value: formData.fuel_type, onChange: (e) => setFormData({
                                                                ...formData,
                                                                fuel_type: e.target.value,
                                                            }), children: [_jsx("option", { value: "Petrol", children: "Petrol" }), _jsx("option", { value: "Diesel", children: "Diesel" }), _jsx("option", { value: "Electric", children: "Electric" }), _jsx("option", { value: "Hybrid", children: "Hybrid" })] })] }), _jsxs("div", { className: "space-y-1", children: [_jsx("label", { className: "text-xs font-bold text-[#C4AD9D] uppercase", children: "Transmission" }), _jsxs("select", { className: "w-full bg-[#001524] border border-[#445048] text-white p-3 rounded-lg", value: formData.transmission, onChange: (e) => setFormData({
                                                                ...formData,
                                                                transmission: e.target.value,
                                                            }), children: [_jsx("option", { value: "Automatic", children: "Automatic" }), _jsx("option", { value: "Manual", children: "Manual" })] })] }), _jsxs("div", { className: "space-y-1", children: [_jsx("label", { className: "text-xs font-bold text-[#C4AD9D] uppercase", children: "Engine Capacity" }), _jsxs("select", { className: "w-full bg-[#001524] border border-[#445048] text-white p-3 rounded-lg", value: formData.engine_capacity, onChange: (e) => setFormData({
                                                                ...formData,
                                                                engine_capacity: e.target.value,
                                                            }), children: [_jsx("option", { value: "1.0L", children: "1.0L" }), _jsx("option", { value: "1.5L", children: "1.5L" }), _jsx("option", { value: "2.0L", children: "2.0L" }), _jsx("option", { value: "2.5L", children: "2.5L" }), _jsx("option", { value: "3.0L", children: "3.0L" }), _jsx("option", { value: "3.5L", children: "3.5L" })] })] }), _jsxs("div", { className: "space-y-1", children: [_jsx("label", { className: "text-xs font-bold text-[#C4AD9D] uppercase", children: "Seats" }), _jsx("select", { className: "w-full bg-[#001524] border border-[#445048] text-white p-3 rounded-lg", value: formData.seating_capacity, onChange: (e) => setFormData({
                                                                ...formData,
                                                                seating_capacity: parseInt(e.target.value),
                                                            }), children: [2, 4, 5, 7, 8].map((num) => (_jsxs("option", { value: num, children: [num, " Seats"] }, num))) })] }), _jsxs("div", { className: "space-y-1", children: [_jsx("label", { className: "text-xs font-bold text-[#C4AD9D] uppercase", children: "Color" }), _jsx("input", { className: "w-full bg-[#001524] border border-[#445048] text-white p-3 rounded-lg", value: formData.color, onChange: (e) => setFormData({ ...formData, color: e.target.value }), placeholder: "e.g. White" })] }), _jsxs("div", { className: "md:col-span-2 space-y-1", children: [_jsx("label", { className: "text-xs font-bold text-[#C4AD9D] uppercase", children: "Features" }), _jsx("input", { className: "w-full bg-[#001524] border border-[#445048] text-white p-3 rounded-lg", value: formData.features, onChange: (e) => setFormData({ ...formData, features: e.target.value }), placeholder: "GPS, Bluetooth, Sunroof" })] }), _jsxs("div", { className: "md:col-span-2 space-y-1", children: [_jsx("label", { className: "text-xs font-bold text-[#C4AD9D] uppercase", children: "Image URL" }), _jsx("input", { className: "w-full bg-[#001524] border border-[#445048] text-white p-3 rounded-lg", value: formData.image_url, onChange: (e) => setFormData({
                                                                ...formData,
                                                                image_url: e.target.value,
                                                            }), placeholder: "https://example.com/image.jpg" }), formData.image_url && (_jsxs("div", { className: "mt-2 flex items-center gap-3", children: [_jsx("div", { className: "w-32 h-32 rounded-lg border border-[#445048] overflow-hidden", children: _jsx("img", { src: formData.image_url, alt: "Preview", className: "w-full h-full object-cover", onError: (e) => {
                                                                            e.target.style.display =
                                                                                "none";
                                                                        } }) }), _jsx("div", { className: "text-sm text-[#C4AD9D]", children: "Image preview will appear here" })] }))] }), _jsxs("div", { className: "md:col-span-2 border-t border-[#445048] pt-4 mt-4", children: [_jsxs("div", { className: "flex items-center justify-between mb-4", children: [_jsx("h4", { className: "font-bold text-white", children: "Promotion Settings" }), _jsx("div", { className: "flex items-center gap-2", children: _jsxs("label", { className: "flex items-center gap-2 text-sm text-[#C4AD9D]", children: [_jsx("input", { type: "checkbox", checked: formData.on_promo, onChange: (e) => setFormData({
                                                                                    ...formData,
                                                                                    on_promo: e.target.checked,
                                                                                }), className: "rounded" }), "Enable Promotion"] }) })] }), formData.on_promo && (_jsxs("div", { className: "grid grid-cols-1 md:grid-cols-2 gap-4", children: [_jsxs("div", { className: "space-y-1", children: [_jsx("label", { className: "text-xs font-bold text-[#C4AD9D] uppercase", children: "Discount Rate (%)" }), _jsx("input", { type: "number", min: "0", max: "100", className: "w-full bg-[#001524] border border-[#445048] text-white p-3 rounded-lg", value: formData.promo_rate, onChange: (e) => setFormData({
                                                                                ...formData,
                                                                                promo_rate: parseFloat(e.target.value),
                                                                            }), placeholder: "e.g., 15" })] }), _jsxs("div", { className: "space-y-1", children: [_jsx("label", { className: "text-xs font-bold text-[#C4AD9D] uppercase", children: "Start Date" }), _jsx("input", { type: "date", className: "w-full bg-[#001524] border border-[#445048] text-white p-3 rounded-lg", value: formData.promo_start_date, onChange: (e) => setFormData({
                                                                                ...formData,
                                                                                promo_start_date: e.target.value,
                                                                            }) })] }), _jsxs("div", { className: "space-y-1", children: [_jsx("label", { className: "text-xs font-bold text-[#C4AD9D] uppercase", children: "End Date" }), _jsx("input", { type: "date", className: "w-full bg-[#001524] border border-[#445048] text-white p-3 rounded-lg", value: formData.promo_end_date, onChange: (e) => setFormData({
                                                                                ...formData,
                                                                                promo_end_date: e.target.value,
                                                                            }) })] })] }))] })] }), _jsxs("div", { className: "flex justify-between pt-4 border-t border-[#445048]", children: [_jsx("button", { type: "button", onClick: () => setCurrentStep("select"), className: "px-6 py-2 border border-[#445048] text-[#C4AD9D] hover:text-white rounded-lg hover:border-white/30 transition-colors", children: "Back" }), _jsxs("button", { type: "submit", className: "bg-[#027480] text-white px-6 py-2 rounded-lg font-bold hover:bg-[#025e69] transition-colors flex items-center gap-2", children: [useExistingSpec
                                                            ? "Use This Spec"
                                                            : "Create Specification", " ", _jsx(ArrowRight, { size: 16 })] })] })] })), currentStep === "inventory" && (_jsxs("form", { onSubmit: handleCreateInventoryStep, className: "space-y-6", children: [createdSpecData && (_jsxs("div", { className: "bg-[#001524] border border-[#027480]/30 p-4 rounded-lg", children: [_jsxs("div", { className: "flex items-center gap-2 text-[#027480] mb-1", children: [_jsx(CheckCircle2, { size: 18 }), _jsx("span", { className: "font-bold text-xs uppercase tracking-wide", children: "Specification Ready" })] }), _jsx("p", { className: "font-bold text-xl text-white", children: createdSpecData.name }), _jsxs("p", { className: "text-xs text-[#C4AD9D]", children: ["Spec ID: ", createdSpecData.id] })] })), _jsxs("div", { className: "grid grid-cols-1 md:grid-cols-2 gap-4", children: [_jsxs("div", { className: "space-y-1", children: [_jsx("label", { className: "text-xs font-bold text-[#C4AD9D] uppercase", children: "VIN Number *" }), _jsx("input", { required: true, className: "w-full bg-[#001524] border border-[#445048] text-white p-3 rounded-lg", value: formData.vin_number, onChange: (e) => setFormData({
                                                                ...formData,
                                                                vin_number: e.target.value,
                                                            }), placeholder: "e.g. 1HGCM82633A123456" })] }), _jsxs("div", { className: "space-y-1", children: [_jsx("label", { className: "text-xs font-bold text-[#C4AD9D] uppercase", children: "License Plate *" }), _jsx("input", { required: true, className: "w-full bg-[#001524] border border-[#445048] text-white p-3 rounded-lg", value: formData.license_plate, onChange: (e) => setFormData({
                                                                ...formData,
                                                                license_plate: e.target.value,
                                                            }), placeholder: "e.g. KDT 132R" })] }), _jsxs("div", { className: "space-y-1", children: [_jsx("label", { className: "text-xs font-bold text-[#C4AD9D] uppercase", children: "Current Mileage" }), _jsx("input", { type: "number", required: true, className: "w-full bg-[#001524] border border-[#445048] text-white p-3 rounded-lg", value: formData.current_mileage, onChange: (e) => setFormData({
                                                                ...formData,
                                                                current_mileage: parseInt(e.target.value),
                                                            }), min: "0" })] }), _jsxs("div", { className: "space-y-1", children: [_jsx("label", { className: "text-xs font-bold text-[#C4AD9D] uppercase", children: "Daily Rate ($)" }), _jsx("input", { type: "number", required: true, className: "w-full bg-[#001524] border border-[#445048] text-white p-3 rounded-lg", value: formData.rental_rate, onChange: (e) => setFormData({
                                                                ...formData,
                                                                rental_rate: parseFloat(e.target.value),
                                                            }), min: "0", step: "0.01" })] }), _jsxs("div", { className: "space-y-1", children: [_jsx("label", { className: "text-xs font-bold text-[#C4AD9D] uppercase", children: "Availability" }), _jsxs("select", { className: "w-full bg-[#001524] border border-[#445048] text-white p-3 rounded-lg", value: formData.status, onChange: (e) => setFormData({
                                                                ...formData,
                                                                status: e.target.value,
                                                            }), children: [_jsx("option", { value: "Available", children: "Available" }), _jsx("option", { value: "Rented", children: "Rented" }), _jsx("option", { value: "Maintenance", children: "Maintenance" }), _jsx("option", { value: "Unavailable", children: "Unavailable" })] })] })] }), _jsxs("div", { className: "flex justify-between pt-4 border-t border-[#445048]", children: [_jsxs("button", { type: "button", onClick: () => setCurrentStep("specs"), className: "px-6 py-2 border border-[#445048] text-[#C4AD9D] hover:text-white rounded-lg hover:border-white/30 transition-colors flex items-center gap-2", children: [_jsx(ArrowLeft, { size: 16 }), " Back to Specs"] }), _jsx("button", { type: "submit", className: "bg-[#F57251] text-white px-6 py-2 rounded-lg font-bold hover:bg-[#d65f41] transition-colors", children: "Finish & Save Vehicle" })] })] }))] })] }) })), isEditModalOpen && currentEditingVehicle && (_jsx("div", { className: "fixed inset-0 bg-black/60 backdrop-blur-sm flex items-center justify-center z-50 p-4", children: _jsxs("div", { className: "bg-[#0f2434] rounded-2xl w-full max-w-4xl shadow-2xl overflow-hidden flex flex-col max-h-[90vh] border border-[#445048]", children: [_jsxs("div", { className: "bg-[#001524] p-6 flex justify-between items-center text-[#E9E6DD]", children: [_jsxs("div", { children: [_jsx("h2", { className: "text-2xl font-bold", children: "Edit Vehicle" }), _jsxs("p", { className: "text-[#C4AD9D] text-sm", children: [currentEditingVehicle.manufacturer, " ", currentEditingVehicle.model] })] }), _jsx("button", { onClick: () => setIsEditModalOpen(false), className: "text-[#C4AD9D] hover:text-white text-2xl p-2 rounded-full hover:bg-white/10", children: _jsx(X, { size: 24 }) })] }), _jsx("div", { className: "p-6 overflow-y-auto", children: _jsxs("form", { onSubmit: handleEditSave, className: "space-y-6", children: [_jsxs("div", { className: "grid grid-cols-1 md:grid-cols-2 gap-4", children: [_jsxs("div", { className: "space-y-1", children: [_jsx("label", { className: "text-xs font-bold text-[#C4AD9D] uppercase", children: "Manufacturer *" }), _jsx("input", { required: true, className: "w-full bg-[#001524] border border-[#445048] text-white p-3 rounded-lg", value: formData.manufacturer, onChange: (e) => setFormData({
                                                            ...formData,
                                                            manufacturer: e.target.value,
                                                            ...
                                                            seating_capacity: parseInt(e.target.value),
                                                                    ...
                                                                    e.target.style.display =
                                                                        "none";
                                                                            ...
                                                                            ...formData,
                                                                            vin_number: e.target.value,
                                                                        }) })] }), _jsxs("div", { className: "space-y-1", children: [_jsx("label", { className: "text-xs font-bold text-[#C4AD9D] uppercase", children: "License Plate" }), _jsx("input", { required: true, className: "w-full bg-[#001524] border border-[#445048] text-white p-3 rounded-lg", value: formData.license_plate, onChange: (e) => setFormData({
                                                                            ...formData,
                                                                            license_plate: e.target.value,
                                                                        }) })] }), _jsxs("div", { className: "space-y-1", children: [_jsx("label", { className: "text-xs font-bold text-[#C4AD9D] uppercase", children: "Mileage" }), _jsx("input", { type: "number", required: true, className: "w-full bg-[#001524] border border-[#445048] text-white p-3 rounded-lg", value: formData.current_mileage, onChange: (e) => setFormData({
                                                                            ...formData,
                                                                            current_mileage: parseInt(e.target.value),
                                                                        }) })] }), _jsxs("div", { className: "space-y-1", children: [_jsx("label", { className: "text-xs font-bold text-[#C4AD9D] uppercase", children: "Daily Rate ($)" }), _jsx("input", { type: "number", required: true, className: "w-full bg-[#001524] border border-[#445048] text-white p-3 rounded-lg", value: formData.rental_rate, onChange: (e) => setFormData({
                                                                            ...formData,
                                                                            rental_rate: parseFloat(e.target.value),
                                                                        }) })] }), _jsxs("div", { className: "space-y-1", children: [_jsx("label", { className: "text-xs font-bold text-[#C4AD9D] uppercase", children: "Availability" }), _jsxs("select", { className: "w-full bg-[#001524] border border-[#445048] text-white p-3 rounded-lg", value: formData.status, onChange: (e) => setFormData({
                                                                            ...formData,
                                                                            status: e.target.value,
                                                                        }), children: [_jsx("option", { value: "Available", children: "Available" }), _jsx("option", { value: "Rented", children: "Rented" }), _jsx("option", { value: "Maintenance", children: "Maintenance" }), _jsx("option", { value: "Unavailable", children: "Unavailable" })] })] })] })] }), _jsxs("div", { className: "md:col-span-2 border-t border-[#445048] pt-4 mt-2", children: [_jsxs("div", { className: "flex items-center justify-between mb-4", children: [_jsx("h4", { className: "font-bold text-white", children: "Promotion Settings" }), _jsx("div", { className: "flex items-center gap-2", children: _jsxs("label", { className: "flex items-center gap-2 text-sm text-[#C4AD9D]", children: [_jsx("input", { type: "checkbox", checked: formData.on_promo, onChange: (e) => setFormData({
                                                                                ...formData,
                                                                                on_promo: e.target.checked,
                                                                            }), className: "rounded" }), "Enable Promotion"] }) })] }), formData.on_promo && (_jsxs("div", { className: "grid grid-cols-1 md:grid-cols-2 gap-4", children: [_jsxs("div", { className: "space-y-1", children: [_jsx("label", { className: "text-xs font-bold text-[#C4AD9D] uppercase", children: "Discount Rate (%)" }), _jsx("input", { type: "number", min: "0", max: "100", className: "w-full bg-[#001524] border border-[#445048] text-white p-3 rounded-lg", value: formData.promo_rate, onChange: (e) => setFormData({
                                                                            ...formData,
                                                                            promo_rate: parseFloat(e.target.value),
                                                                        }) })] }), _jsxs("div", { className: "space-y-1", children: [_jsx("label", { className: "text-xs font-bold text-[#C4AD9D] uppercase", children: "Start Date" }), _jsx("input", { type: "date", className: "w-full bg-[#001524] border border-[#445048] text-white p-3 rounded-lg", value: formData.promo_start_date, onChange: (e) => setFormData({
                                                                            ...formData,
                                                                            promo_start_date: e.target.value,
                                                                        }) })] }), _jsxs("div", { className: "space-y-1", children: [_jsx("label", { className: "text-xs font-bold text-[#C4AD9D] uppercase", children: "End Date" }), _jsx("input", { type: "date", className: "w-full bg-[#001524] border border-[#445048] text-white p-3 rounded-lg", value: formData.promo_end_date, onChange: (e) => setFormData({
                                                                            ...formData,
